...
public class CustomModelMapper {
    ...
    Converter<Create, List<String>> toListTag = new Converter<Create, List<String>>() {
        @Override
    ...
    public ModelMapper createMapper() {
        ...
        modelMapper.createTypeMap(Create.class, CreateDTO.class)
                .addMappings(modelMapper -> modelMapper.using(toListTag).map(src -> src, CreateDTO::setTag))
    ...
    public ModelMapper buyMapper() {
        ...
        modelMapper.createTypeMap(Buy.class, BuyDTO.class)
                .addMappings(modelMapper -> modelMapper.using(toListTag).map(src -> src, BuyDTO::setTag))
    ...
    public ModelMapper sellMapper() {
        ...
        modelMapper.createTypeMap(Sell.class, SellDTO.class)
                .addMappings(modelMapper -> modelMapper.using(toListTag).map(src -> src, SellDTO::setTag))
    ...
    public ModelMapper likeMapper() {
        ...
        modelMapper.createTypeMap(Like.class, LikeDTO.class)
                .addMappings(modelMapper -> modelMapper.using(toListTag).map(src -> src, LikeDTO::setTag))
